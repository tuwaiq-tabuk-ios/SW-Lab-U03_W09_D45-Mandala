...
//  Mandala"Reema.Mousa
//
//  Created by Reema Mousa on 08/05/1443 AH.
//
...
//    view.backgroundColor = view.tintColor
  ...
  private func configureViewHierarchy() {
    ...
    NSLayoutConstraint.activate([
      ...
      highlightView.heightAnchor.constraint(equalTo: highlightView.widthAnchor), highlightView.heightAnchor.constraint(equalTo:heightAnchor, multiplier: 0.9),
