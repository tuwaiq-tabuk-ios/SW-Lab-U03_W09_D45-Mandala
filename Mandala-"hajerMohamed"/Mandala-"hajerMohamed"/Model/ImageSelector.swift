//
//  ImageSelector.swift
//  Mandala-"hajerMohamed"
//
//  Created by hajer . on 06/05/1443 AH.
//
...
class ImageSelector: UIControl {
    ...
    private func configureViewHierarchy() {
        ...
        NSLayoutConstraint.activate([
            ...
            highlightView.heightAnchor.constraint(equalTo: highlightView.widthAnchor), highlightView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 0.9), highlightView.centerYAnchor.constraint(equalTo: selectorStackView.centerYAnchor),
        ]) }
