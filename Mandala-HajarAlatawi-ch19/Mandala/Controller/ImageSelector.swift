...
//  Mandala
//
//  Created by HAJAR on 11/12/2021.
//
...
class ImageSelector: UIControl {
  ...
  private func configureViewHierarchy() {
    ...
    insertSubview(highlightView,
                  belowSubview: selectorStackView)
    ...
    NSLayoutConstraint.activate([
      ...
      highlightView.heightAnchor.constraint(equalTo: heightAnchor,
                                            multiplier: 0.9),
  ...
  override func layoutSubviews() {
    ...
    highlightView.layer.cornerRadius
    = highlightView.bounds.width / 2.0
  }
  ...
  var selectedIndex = 0 {
    ...
    didSet {
      ...
      = highlightColor(forIndex: selectedIndex)
