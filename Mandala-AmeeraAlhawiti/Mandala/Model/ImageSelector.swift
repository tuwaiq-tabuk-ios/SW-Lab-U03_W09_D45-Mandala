...
//  Mandala
//
//  Created by Ameera BA on 11/12/2021.
//
...
class ImageSelector: UIControl {
  ...
  private func configureViewHierarchy() {
    ...
    NSLayoutConstraint.activate([
      ...
      highlightView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 0.9), highlightView.centerYAnchor
  ...
  // MARK: - Adding the highlight view
  ...
  //  MARK: - Setting the corner radius
  override func layoutSubviews() {
    super.layoutSubviews()
    highlightView.layer.cornerRadius = highlightView.bounds.width / 2.0
  }
  
//  MARK: - Implementing a method to return a highlight color
