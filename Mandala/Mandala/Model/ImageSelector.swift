//
//  ImageSelector.swift
//  Mandala-Ahlam Albalawi
//
//  Created by ahlam  on 08/05/1443 AH.
//
...
private func configureViewHierarchy() {
  ...
  NSLayoutConstraint.activate([
    ...
    highlightView.heightAnchor.constraint(equalTo: highlightView.widthAnchor), highlightView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 0.9), highlightView.centerYAnchor
