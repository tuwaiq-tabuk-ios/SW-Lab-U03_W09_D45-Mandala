//
//  ImageSelector.swift
//  Mandala_MohammedALatawi
//
//  Created by محمد العطوي on 07/05/1443 AH.
//
...
class ImageSelector: UIControl {
  ...
  private func configureViewHierarchy() {
    ...
    NSLayoutConstraint.activate([
      ...
      highlightView.heightAnchor.constraint(equalTo: highlightView.widthAnchor), highlightView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 0.7), highlightView.centerYAnchor
